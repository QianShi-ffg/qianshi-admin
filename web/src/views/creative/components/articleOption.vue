...
onMounted(() => {
  const icon = document.getElementsByClassName('md-editor-toolbar-item').length === 0 ? document.getElementsByClassName('md-toolbar-item') : document.getElementsByClassName('md-editor-toolbar-item')
