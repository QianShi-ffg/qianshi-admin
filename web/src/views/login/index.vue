    ...
    <div class="container" id="container" :class="containerClass">
      <div>
        <div class="form-container sign-up-container" v-if="type === 'signUp'">
          <form action="#">
            <h1>创建账户</h1>
            <el-input v-model="name" placeholder="Name" :suffix-icon="Search" size="large" maxlength="16" />
            <el-input v-model="password" type="password" placeholder="Password" show-password size="large"
              maxlength="16" />
